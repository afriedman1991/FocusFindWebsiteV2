        ...
        <div id="Press Kit" className="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="lg:pr-4">
                        <div className="lg:max-w-lg">
                            <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">General Information</h1>
                            ...
                            <li className="mt-6 text-xl leading-8 text-gray-700">
                                Languages: English, Spanish, French, German, Russian, Japanese, Korean, Chinese
                            </li>
                            <li className="mt-6 text-xl leading-8 text-gray-700">
                                Release Date: TBA
                            </li>
            ...
            <div className="bg-none">
                <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 ">
                    <h2 className="text-2xl font-bold tracking-tight text-gray-300 text-shadow">Art and Logos</h2>
            ...
            <div className="bg-none">
                <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 ">
                    <h2 className="text-2xl font-bold tracking-tight text-gray-300 text-shadow">Screenshots</h2>
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {products.map((product) => (
                            <ImageCard key={product.id} product={product} />
                        ))}
            ...
            <div className="bg-none">
                <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 ">
                    <h2 className="text-2xl font-bold tracking-tight text-gray-300 text-shadow">Trailer</h2>
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
