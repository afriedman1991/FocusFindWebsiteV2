...
const PressKit: React.FC = () => {
    return (
        <div id="Press Kit" data-testid="press kit" className="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                ...
                <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 ">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {products.map((product, index) => (
                            <LazyImage key={index} src={product.imageSrc} className={product.className} alt={product.imageAlt} />
                        ))}
                    </div>
                </div>
            </div>
